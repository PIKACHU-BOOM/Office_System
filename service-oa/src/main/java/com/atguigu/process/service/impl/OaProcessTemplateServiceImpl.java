...
import com.atguigu.process.controller.OaProcessTemplateController;
...
public class OaProcessTemplateServiceImpl extends ServiceImpl<OaProcessTemplateMapper, ProcessTemplate> implements OaProcessTemplateService {
    ...
    public IPage<ProcessTemplate> selectPageProcessTemplate(Page<ProcessTemplate> pageParam) {
        ...
        List<ProcessTemplate> processTemplatePageList = processTemplatePage.getRecords();
        //3 遍历list集合，得到每个对象的审批类型id
        for(ProcessTemplate processTemplate : processTemplatePageList){
